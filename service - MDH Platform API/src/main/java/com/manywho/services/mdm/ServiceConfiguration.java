...
public class ServiceConfiguration implements Configuration {
    ...
    @Configuration.Setting(name="API Sleep Time (ms)", contentType= ContentType.Number, required=false)
    private int apiSleepTime;

    public int getApiSleepTime() {
		return apiSleepTime;
	}

	public void setApiSleepTime(int apiSleepTime) {
		this.apiSleepTime = apiSleepTime;
	}
